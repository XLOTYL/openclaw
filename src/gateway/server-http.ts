...
/**
 * Expose Prometheus text metrics for operators (unauthenticated, like probes).
 *
 * Other agents: keep this handler shallow — heavy work belongs in `../infra/metrics`.
 */
function handleGatewayPrometheusMetricsRequest(
  req: IncomingMessage,
  res: ServerResponse,
  requestPath: string,
): boolean {
      ...
      const requestStages: GatewayHttpRequestStage[] = [
        {
          ...
          run: () => handleGatewayPrometheusMetricsRequest(req, res, requestPath),
        },
        {
          name: "hooks",
