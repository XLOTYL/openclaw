...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "memory_write",
    label: "memory_write",
    description: "Write memory files",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "memory_update",
    label: "memory_update",
    description: "Update memory files",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  {
    id: "sessions_lifecycle",
    label: "sessions_lifecycle",
    description: SESSIONS_LIFECYCLE_TOOL_DISPLAY_SUMMARY,
    sectionId: "sessions",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "operator",
    label: "operator",
    description: OPERATOR_TOOL_DISPLAY_SUMMARY,
    sectionId: "automation",
    profiles: [],
    includeInOpenClawGroup: true,
  },
